    ...
    <>
      <div className="relative">
        ...
        {input && result.length > 0 && (
          <div className="w-full border-2 rounded-lg mt-3 py-2 bg-white overflow-y-auto custom__scrollbar px-2">
            {result.map((searchResult, index) => (
              <div
                key={index}
                className="flex flex-col lg:flex-row hover:bg-gray-100 px-3 rounded-lg mb-2 lg:mb-0 lg:h-[72px] items-center justify-between"
              >
                ...
                <div className="flex flex-col font-medium text-[12px] justify-end items-end lg:w-1/4">
