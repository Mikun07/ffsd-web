      ...
      if (lowerCaseTerm.startsWith("admin status")) {
        ...
        const filtered = data.filter(
          (item) =>
            ...
            item.system_admin_type?.toString().includes(lowerCaseTerm) ||
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <div className="font-medium gap-[0.5rem]">
                  ...
                  <div className="flex items-center gap-2">
                    <p className="text-[10px] font-medium text-gray-400 lowercase">
                      {searchResult?.email}
                    </p>
                  </div>
                </div>
              ...
              <div className="flex flex-col font-medium items-end">
                <div className="flex items-center justify-end gap-2 text-gray-400">
                  <p className="flex items-center text-[10px] capitalize">
                    admin status {searchResult?.system_admin_type}
                  </p>
                </div>
              </div>
            </div>
